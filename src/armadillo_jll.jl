...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import armadillo_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0631256a-41da-5d69-bb72-795e0d5510ec"))
platforms = [Pkg.Artifacts.unpack_platform(e, "armadillo", artifacts_toml) for e in artifacts["armadillo"]]
...
if best_platform === nothing
    @debug("Unable to load armadillo; unsupported platform $(triplet(platform_key_abi()))")
else
